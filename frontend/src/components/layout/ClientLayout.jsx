          ...
          <div className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center gap-4">
              <button 
                ...
                className="lg:hidden text-gris-ardoise hover:text-or"
              >
            ...
            <div className="flex items-center gap-4">
              <button className="relative text-gray-500 hover:text-or">
                <Bell className="w-5 h-5" />
              </button>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-or flex items-center justify-center">
                  <span className="text-gris-ardoise text-sm font-semibold">
